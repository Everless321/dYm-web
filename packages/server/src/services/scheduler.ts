...
import { getAutoSyncUsers, getAutoSyncTasks, updateTaskLastSyncAt, type DbUser, type DbTaskWithUsers } from '../database/index.js'
import { startUserSync, isUserSyncing } from './syncer.js'
import { startDownloadTask, isTaskRunning } from './downloader.js'
...
function sendSchedulerLog(log: Omit<SchedulerLog, 'timestamp'>): void {
  ...
  broadcast({ channel: 'scheduler:log', data: fullLog })
